//  Introduced products array as a mock database
//  Each product includes id, title, description, price, category, and metadata
//  UUID is used to generate unique identifiers for each product
import { v4 as uuid } from "uuid";

export const products = [
//  feat: add Indian cuisine products with detailed metadata
//  Includes vegetarian and non-vegetarian options
//  Provides ratings, restaurant names, and images for UI display
  ...
  // feat: add multiple Indian dishes to enhance category diversity
  {
    _id: uuid(),
    title: "Biryani",
  ...
  // feat: add Chinese cuisine products with variety of dishes
  // Covers noodles, rice, soups, and specialty items
  // Chinese Category
  {
    _id: uuid(),
